...
break;
case 3: console.log("Reconocio : "+ yy_.yytext); return 8
break;
case 4: console.log("Reconocio : "+ yy_.yytext); return 17
break;
case 5: console.log("Reconocio : "+ yy_.yytext); return 11
break;
case 6: this.begin("S1"); $ESPACIOS=""; console.log("Reconocio : "+ yy_.yytext); return ">";
break;
case 7: $ESPACIOS += yy.lexer.match;
break;
case 8: this.begin("INITIAL"); console.log("Reconocio : "+ yy_.yytext); return "<";
break;
case 9: yy_.yytext = $ESPACIOS + yy_.yytext; $ESPACIOS="";  console.log("Reconocio : "+ yy_.yytext); return 19; 
break;
case 10:return 5
break;
case 11: console.log("Error Lexico "+yy_.yytext
                        +" linea "+yy_.yylineno
...
rules: [/^(?:\s+)/i,/^(?:(("((\\([\'\"\\ntr]))|([^\"\\]+))*")))/i,/^(?:([a-zñA-ZÑ_][a-zñA-ZÑ0-9_]*))/i,/^(?:<)/i,/^(?:=)/i,/^(?:\/)/i,/^(?:>)/i,/^(?:\s)/i,/^(?:<)/i,/^(?:.)/i,/^(?:$)/i,/^(?:.)/i],
conditions: {"S1":{"rules":[7,8,9,10,11],"inclusive":true},"INITIAL":{"rules":[0,1,2,3,4,5,6,10,11],"inclusive":true}}
});
return lexer;
})();
parser.lexer = lexer;
