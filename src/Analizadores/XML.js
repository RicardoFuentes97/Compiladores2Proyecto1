...
break;
case 2:
 gram.getInstancia('raices -> raices raiz; \n'); $$[$0-1].push($$[$0]); this.$ = $$[$0-1];
break;
case 3:
 gram.getInstancia('raices -> raiz; \n'); this.$ = [$$[$0]]; 
break;
case 4:
 gram.getInstancia('raiz -> objeto; \n'); this.$ = $$[$0]; 
break;
case 5:
 gram.getInstancia('objeto -> < ID latributos / >; \n'); this.$ = new Objeto.default($$[$0-3],'',_$[$0-4].first_line, _$[$0-4].first_column,$$[$0-2],[],1); 
break;
case 6:
 gram.getInstancia('objeto -> < ID latributos >  texto_libre  < / ID >; \n'); this.$ = new Objeto.default($$[$0-7],$$[$0-4],_$[$0-8].first_line, _$[$0-8].first_column,$$[$0-6],[],2);
break;
case 7:
 gram.getInstancia('objeto -> < ID latributos >  objetos </ID >; \n'); this.$ = new Objeto.default($$[$0-7],'',_$[$0-8].first_line, _$[$0-8].first_column,$$[$0-6],$$[$0-4],2);
break;
case 8:
 gram.getInstancia('objetos -> objetos objeto; \n'); $$[$0-1].push($$[$0]); this.$ = $$[$0-1];
break;
case 9:
 gram.getInstancia('raiz -> objeto; \n'); this.$ = [$$[$0]]; 
break;
case 10:
 gram.getInstancia('latributos -> atributos; \n'); this.$ = $$[$0];
break;
case 11:
 gram.getInstancia('latributos -> []; \n'); this.$ = [];
break;
case 12:
 gram.getInstancia('atributos -> atributos atributo; \n'); $$[$0-1].push($$[$0]); this.$ = $$[$0-1];
break;
case 13:
 gram.getInstancia('atributos -> atributo; \n'); this.$ = [$$[$0]];
break;
case 14:
 gram.getInstancia('atributo -> ID = CADENA; \n'); this.$ = new Atributo.default($$[$0-2], $$[$0], _$[$0-2].first_line, _$[$0-2].first_column);
break;
case 15:
 gram.getInstancia('texto_libre -> texto_libre TEXTO; \n'); this.$ = $$[$0-1] + $$[$0];
break;
case 16:
 gram.getInstancia('texto_libre -> TEXTO; \n'); this.$ = $$[$0];
break;
}
},
